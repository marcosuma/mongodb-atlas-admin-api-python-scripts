# python script for calling Atlas Admin API
...
# Make the API call
response = requests.patch(api_url, json=request_body, auth=auth, headers={"Accept": "application/vnd.atlas.2023-11-15+json"})
